...
$GLOBALS['TL_DCA']['tl_module']['palettes']['figur_products'] = '{title_legend},name,headline,type;{redirect_legend},iso_link_primary,iso_addProductJumpTo;{template_legend:hide},customTpl,iso_list_layout,iso_use_quantity,iso_buttons;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
